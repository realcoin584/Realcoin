...
if(screen.height<740){
    ...
    //CHANGE THE SIZE OF realCoins_mainContainer MATCH
    realCoins_mainContainer.style.height=`${screen.height-138}px`;
    realCoins_mainContainer_body.style.height=`${screen.height-200-138}px`;
    realCoins_mainContainer_home.style.height=`${screen.height-200-138}px`;
    realCoins_mainContainer_x2.style.height=`${screen.height-200-138}px`;
    realCoins_mainContainer_boost.style.height=`${screen.height-200-138}px`;realCoins_mainContainer_earn.style.height=`${screen.height-200-138}px`;
    realCoins_mainContainer_bobols.style.height=`${screen.height-200-138}px`;
    realCoins_mainContainer_dailyCipher.style.height=`${screen.height-200-138}px`;
    realCoins_mainContainer_ref.style.height=`${screen.height-200-138}px`;
